...
// Dashboard v2
// --------------------------------------------------------------------------- //
export function Dashboard({ onGoReports, onGoReview }: { onGoReports: () => void; onGoReview: () => void }) {
...
export function TheorySection({ canReview }: { canReview: boolean }) {
...
export function ReviewQueue({ canReview }: { canReview: boolean }) {
